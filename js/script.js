$(function(){
    ...
    setInterval(function() {
        ...
        $.get("cart/data.php?q=countmessages", function(data){
            $('.messages-admin-badge').html(data);
        });

        $.get("cart/data.php?q=countcustomers", function(data){
            $('.customer-admin-badge').html(data);
        });
