			...
			<div class="row">
                ...
                <div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						<h3 class="title text-center">Orders</h3>                                            					
<!-- Nav tabs -->
        ...
        <table class="table table-bordered">
            ...
            <?php while($row = mysql_fetch_array($unpaid)){ ?>
                <tr>
                    ...
                    <td class="text-center"><a href="item.php?id=<?php echo $row['id']?>&&p=unconfirmed" target="_blank"><i class="fa fa-external-link"></i> View Order Information</a></td>
        ...
        <table class="table table-bordered">
            ...
            <?php while($row = mysql_fetch_array($delivered)){ ?>
                <tr>
                    ...
                    <td><?php echo $row['name']; ?></td>
                    <td class="text-center"><a href="item.php?id=<?php echo $row['id']?>&&p=delivered" target="_blank"><i class="fa fa-external-link"></i> View Order Information</a></td>
        ...
        <table class="table table-bordered">
            ...
            <?php while($row = mysql_fetch_array($paid)){ ?>
                <tr>
                    <td class="text-center"><?php echo $row['dateDelivered']; ?></td>
                    <td><?php echo $row['name']; ?></td>
                    <td class="text-center"><a href="item.php?id=<?php echo $row['id']?>" target="_blank"><i class="fa fa-external-link"></i> View Order Information</a></td>                    
                </tr>
            <?php } ?>
        </table>
    </div>
