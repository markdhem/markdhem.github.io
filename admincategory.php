					...
					<div class="features_items"><!--features_items-->
                        ...
                        <form method="POST" action="admincategory.php">
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input name="category" class="form-control" type="text" placeholder="..." required>
                       ...
                       <hr />
                        <table class="table table-bordered">
                            <thead style="text-align: center; font-weight: bolder; background-color: #222d32; color: #fff; font-size: 10px;">
                                <th>Name</th>
